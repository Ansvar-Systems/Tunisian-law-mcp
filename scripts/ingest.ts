 ...
 * from legislation.tn (Akoma Ntoso HTML).
 *
 * Features:
 ...
 *
 * Data source: legislation.tn (National Council for Law Reporting)
...
import { parseTunisiaLawHtml, type ActIndexEntry, type ParsedAct } from './lib/parser.js';
...
async function main(): Promise<void> {
  ...
  console.log('====================================================\n');
  console.log(`  Source: legislation.tn (National Council for Law Reporting)`);
  ...
  for (const law of acts) {
    ...
    try {
      ...
      const parsed = parseTunisiaLawHtml(html, act);
  ...
  console.log(`\n  Source:      legislation.tn (Akoma Ntoso HTML)`);
