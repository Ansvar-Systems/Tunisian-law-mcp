...
**The Tunisia Law alternative for the AI age.**

[![npm version](https://badge.fury.io/js/%40ansvar/tunisia-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/tunisia-law-mcp)
[![MCP Registry](https://img.shields.io/badge/MCP-Registry-blue)](https://registry.modelcontextprotocol.io)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![GitHub stars](https://img.shields.io/github/stars/Ansvar-Systems/Tunisia-law-mcp?style=social)](https://github.com/Ansvar-Systems/Tunisia-law-mcp)
[![CI](https://github.com/Ansvar-Systems/Tunisia-law-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/Tunisia-law-mcp/actions/workflows/ci.yml)
...
Query **494 Tunisian Acts** -- from the Data Protection Act and Computer Misuse and Cybercrimes Act to the Companies Act, Constitution of Tunisia, and more -- directly from Claude, Cursor, or any MCP-compatible client.
...
Tunisian legal research is scattered across Tunisia Law Reports, the Tunisia Gazette, and various government portals. Whether you're:
- A **lawyer** validating citations in a brief or contract under Tunisian law
- A **compliance officer** checking if the Data Protection Act 2019 provisions apply to your processing activities
- A **legal tech developer** building tools on Tunisian legislation
...
**Endpoint:** `https://tunisia-law-mcp.vercel.app/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add tunisia-law --transport http https://tunisia-law-mcp.vercel.app/mcp` |
...
```json
{
  "mcpServers": {
    "tunisia-law": {
      "type": "url",
      "url": "https://tunisia-law-mcp.vercel.app/mcp"
    }
  }
}
```
...
- *"What does the Constitution of Tunisia say about the right to privacy?"*
- *"Search for data breach notification requirements in Tunisian law"*
- *"What are the obligations under the National Payment Systems Act?"*
- *"Validate this legal citation"*
- *"Build a legal stance on personal data processing in Tunisia"*
...
| **Tunisia Information and Communications Act** | 1998 (amended) | Regulates telecommunications and ICT sector; establishes the Communications Authority of Tunisia |
...
| **Constitution of Tunisia** | 2010 | Supreme law; Article 31 guarantees the right to privacy |
...
**Estimated database size:** ~80-150 MB (full corpus of Tunisian federal legislation)
...
| `format_citation` | Format citations per Tunisian conventions (full/short/pinpoint) |
...
| Tool | Description |
|------|-------------|
| `get_eu_basis` | Get EU directives/regulations for Tunisian statute |
| `get_tunisian_implementations` | Find Tunisian laws implementing EU act |
| `search_eu_implementations` | Search EU documents with Tunisian implementation counts |
...
- All statute text is ingested from official Tunisian government sources
...
- **[Tunisia Law Reports](https://tunisialaw.org)** -- Official Tunisian government legal database
...
>
> Statute text is sourced from official Tunisian government publications. However:
...
```bash
git clone https://github.com/Ansvar-Systems/Tunisia-law-mcp
cd Tunisia-law-mcp
npm install
npm run build
npm test
...
**30+ national law MCPs** covering Australia, Brazil, Canada, China, Denmark, Finland, France, Germany, Ghana, Iceland, India, Ireland, Israel, Italy, Japan, Tunisia, Netherlands, Nigeria, Norway, Singapore, Slovenia, South Korea, Sweden, Switzerland, Thailand, UAE, UK, and more.
...
```bibtex
@software{tunisia_law_mcp_2025,
  author = {Ansvar Systems AB},
  title = {Tunisian Law MCP Server: AI-Powered Legal Research Tool},
  year = {2025},
  url = {https://github.com/Ansvar-Systems/Tunisia-law-mcp},
  note = {Tunisian legal database with full-text search and EU cross-references}
}
```
...
- **Statutes & Legislation:** Tunisian Government (public domain)
